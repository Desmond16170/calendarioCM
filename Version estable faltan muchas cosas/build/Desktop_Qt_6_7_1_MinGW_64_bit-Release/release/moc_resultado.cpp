...
struct qt_meta_stringdata_CLASSResultadoENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSResultadoENDCLASS = QtMocHelpers::stringData(
    "Resultado"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSResultadoENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Resultado::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSResultadoENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSResultadoENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSResultadoENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *Resultado::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSResultadoENDCLASS.stringdata0))
